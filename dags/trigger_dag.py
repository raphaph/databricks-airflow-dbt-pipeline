...
with DAG('trigger_dag', description="executará a task3 somente se houver uma falha",
          schedule_interval=None, start_date=datetime(2024,6,25),
          catchup=False) as dag: 

    task1 = BashOperator(task_id='tsk1', bash_command="sleep 5") # simula falha para a task3 executar
